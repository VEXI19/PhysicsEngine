...
class SimulationData:
    ...
    @property
    def rotation_data(self) -> NDArray[np.float64]:
        """
        Returns rotation data of the object

        Returns:
            NDArray[np.float64]: rotation data of the object
        """

        return self._rotation

    @property
    def angular_acceleration_data(self) -> NDArray[np.float64]:
        """
        Returns angular acceleration data of the object

        Returns:
            NDArray[np.float64]: angular acceleration data of the object
        """

        return self._angular_acceleration

    @property
    def angular_velocity_data(self) -> NDArray[np.float64]:
        """
        Returns angular velocity data of the object

        Returns:
            NDArray[np.float64]: angular velocity data of the object
        """
