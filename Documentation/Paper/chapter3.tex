...
\section{PPO - wybrany model do trenowania}
...
\begin{figure}
    ...
    \caption{Trajektoria lotu rakiety przed trenowaniem modelu} \label{Fig1:trajcetory_start}
\end{figure}
\begin{figure}
    ...
    \caption{Trajektoria lotu rakiety po 150 episodach} \label{Fig1:trajcetory_mid}
\end{figure}
\begin{figure}
    ...
    \caption{Trajektoria lotu rakiety wytrenowanego modelu} \label{Fig1:trajcetory_final}
\end{figure}
