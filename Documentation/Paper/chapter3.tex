...
\begin{figure}
    \subfloat[Rzut na płaszczyznę YZ]{\label{Fig1:b2} \includegraphics[width=0.5\textwidth]{images/trajectory_start_x}}%
    \\
    \hfill
    \subfloat[Rzut na płaszczyznę XZ]{\label{Fig1:c2} \includegraphics[width=0.5\textwidth]{images/trajectory_start_y}}

    \caption{Trajektoria lotu rakiety przed trenowaniem modelu, \textit{źródło: Opracowanie własne.}} \label{Fig1:trajcetory_start}
\end{figure}
\begin{figure}
    \subfloat[Rzut na płaszczyznę YZ]{\label{Fig1:b3} \includegraphics[width=0.5\textwidth]{images/trajectory_mid_x}}%
    \\
    \hfill
    \subfloat[Rzut na płaszczyznę XZ]{\label{Fig1:c3} \includegraphics[width=0.5\textwidth]{images/trajectory_mid_y}}

    \caption{Trajektoria lotu rakiety po 150 episodach, \textit{źródło: Opracowanie własne.}} \label{Fig1:trajcetory_mid}
\end{figure}
\begin{figure}
    \subfloat[Rzut na płaszczyznę YZ]{\label{Fig1:b4} \includegraphics[width=0.5\textwidth]{images/trajectory_final_x}}%
    \\
    \hfill
    \subfloat[Rzut na płaszczyznę XZ]{\label{Fig1:c4} \includegraphics[width=0.5\textwidth]{images/trajectory_final_y}}
