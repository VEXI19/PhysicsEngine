...
\begin{figure}[H]
    ...
    \caption{Schemat architektury systemu uczącego. \textit{Opracowanie własne.}}
...
Ta struktura nie tylko umożliwia efektywne trenowanie modeli sterowania, ale także zapewnia możliwość łatwej rozbudowy i modyfikacji poszczególnych komponentów. W kolejnych rozdziałach przedstawione zostaną szczegółowe wyniki osiągnięte dzięki tej architekturze.
