...
Stworzenie silnika fizycznego spełniającego te wymagania jest pośrednim celem
niniejszej pracy.
...
\begin{itemize}
    \item \textbf{Git\cite{chacon2014pro} oraz Github\cite{GitHub}} - narzędzia
    ...
    \item \textbf{Python 3\cite{python3docs}} - język programowania, w którym napisane
    ...
    \item \textbf{PyCharm Professional\cite{pycharm}}  - środowisko programistyczne
...
\begin{itemize}
    \item \textbf{LaTex\cite{mittelbach2004latex}} - system składu tekstu wykorzystany do napisania
    ...
    \item \textbf{SGGW-thesis\cite{chmiel2024sggwthesislatex}} - biblioteka do tworzenia pracy
    inżynierskiej
...
\begin{itemize}
    \item \textbf{Symulink\cite{matlab2019simulink}.} \\Bardzo zaawansowane narzędzie do
...
\begin{itemize}
    \item \textbf{Simulink z Aerospace Blockset\cite{mathworks_aerospace_blockset}.} \\
